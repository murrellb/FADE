...
{
    _cachingOK = 0;
    ExecuteAFile (Join(DIRECTORY_SEPARATOR,{{PATH_TO_CURRENT_BF[0][Abs(PATH_TO_CURRENT_BF)-2],"DEPS_PHASE_1.bf"}}), {"0" : _fubarNucFitLocation});
...
else
{
    ...
    ExecuteAFile (Join(DIRECTORY_SEPARATOR,{{PATH_TO_CURRENT_BF[0][Abs(PATH_TO_CURRENT_BF)-2],"DEPS_PHASE_2.bf"}}), {"0" : _fubarNucFitLocation,
...
else
{
    ...
    ExecuteAFile (Join(DIRECTORY_SEPARATOR,{{PATH_TO_CURRENT_BF[0][Abs(PATH_TO_CURRENT_BF)-2],"DEPS_PHASE_4.bf"}}), {"0" : _fubarNucFitLocation,
                                                                                                                                 "1" : _fubarGridInfoLocation,
...
ExecuteAFile (Join(DIRECTORY_SEPARATOR,{{PATH_TO_CURRENT_BF[0][Abs(PATH_TO_CURRENT_BF)-2],"FUBAR_tools.ibf"}}));
